...
class ItineraryItem(BaseModel):
    ...
    start_time: Optional[DateTimeType] = Field(None, description="Start time")
    end_time: Optional[DateTimeType] = Field(None, description="End time")
...
class DailyItinerary(BaseModel):
    date: DateType = Field(..., description="Date of this itinerary")
...
class ShareLinkResponse(BaseModel):
    ...
    expires_at: DateTimeType = Field(..., description="Expiration timestamp")
