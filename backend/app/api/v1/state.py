...
async def get_state(
    ...
    return await StateService.get_state(db, session_id, user_id)
...
async def confirm_node(
    ...
    try:
        return await StateService.confirm_node(db, session_id, user_id, node_id, data)
...
async def lock_node(
    ...
    return await StateService.lock_node(db, session_id, user_id, node_id)
...
async def unlock_node(
    ...
    return await StateService.unlock_node(db, session_id, user_id, node_id)
...
async def rollback_node(
    ...
    try:
        return await StateService.rollback_node(db, session_id, user_id, node_id)
    except ValueError as e:
        raise HTTPException(status_code=400, detail=str(e))
...
async def batch_confirm(
    ...
    """
    return await StateService.batch_confirm_nodes(db, session_id, user_id)
